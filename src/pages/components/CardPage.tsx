    ...
    <div className="p-6 md:p-10 max-w-6xl mx-auto space-y-12">
      ...
      <div className="space-y-12">
        <ComponentPreview 
          ...
          description="The three core card styles."
          code={`<Card variant="primary">...</Card>\n<Card variant="secondary">...</Card>\n<Card variant="elevated">...</Card>`}
        >
      ...
      <ComponentPreview 
        ...
        description="Examples of cards built for specific product use cases."
        code={`<Card className="flex flex-col gap-4">...</Card>`}
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
          ...
          <Card className="flex flex-col gap-4">
            ...
            <div>
              <span className="text-xs text-gray-400 uppercase font-semibold">Heart Rate</span>
      ...
      <ComponentPreview 
        ...
        description="Cards can contain complex layouts and other components."
          ...
          <div className="grid grid-cols-7 gap-2 mb-8">
            {[40, 70, 45, 90, 65, 30, 50].map((h, i) => (
              <div key={i} className="flex flex-col items-center gap-2">
                ...
                <span className="text-[10px] text-gray-400 font-semibold uppercase">{['M', 'T', 'W', 'T', 'F', 'S', 'S'][i]}</span>
              </div>
            ))}
          </div>
